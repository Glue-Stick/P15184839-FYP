...
void Init(sf::RenderWindow* target, bool loadDefaultFont)
{
...
void Update(sf::Window* window, sf::RenderWindow* target, sf::Time dt)
{
...
void Shutdown()
{
    ...
    ImGui::SFML::Shutdown(); // need to specify namespace here, otherwise ImGui::SFML::Shutdown would be called
}
